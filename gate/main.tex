...
&= 1 * 0.00001 + 5 * 0.9 * 0.0001 + 10 * 0.81 * 0.001 + 10 * 0.729 *  0.01 + 5 * 0.6561 * 0.1 \\
...
&= 3.048
\end{align}
Total number of sets(A) \cbrak{Number of groups}
\begin{align}
A &= \frac{N}{5} \\ &=\frac{1000}{5} \\ &=200
\end{align}
...
\begin{tikzpicture}[node distance=2cm, auto]
  ...
  \draw [arrow] (mix) -- (test);
  \draw [arrow] (mix) -- node[anchor=east] {Yes} (testIndividuals); 
  \draw [arrow] (mix) -- node[anchor=south] {No} (test);
